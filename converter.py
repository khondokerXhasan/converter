import requests,json,base64,marshal,os
...
class fb_link_to_uid():
	...
	def logo(self):
		os.system('clear')
		print()
		print('\x1b[38;5;125m  ____   ___   _   _ __     __ _____  ____   _____  _____  ____  ')
		print('\x1b[38;5;125m / ___| / _ \ | \ | |\ \   / /| ____||  _ \ |_   _|| ____||  _ \ ')
		print('\x1b[38;5;125m| |    | | | ||  \| | \ \ / / |  _|  | |_) |  | |  |  _|  | |_) |')
		print('\x1b[38;5;125m| |___ | |_| || |\  |  \ V /  | |___ |  _ <   | |  | |___ |  _ < ')
		print('\x1b[38;5;125m \____| \___/ |_| \_|   \_/   |_____||_| \_\  |_|  |_____||_| \_\\')
		print('\n\t\t\x1b[38;5;140m ( \x1b[1;93mFind FB UID from Profile Link \x1b[38;5;140m)')
		print()
		print('\t\t\x1b[38;5;172m[ Developed by\x1b[38;5;161m Khondoker \x1b[1;92mX \x1b[38;5;161mHasan\x1b[38;5;172m ]')
		print('\t\t\x1b[38;5;172m[github]: \x1b[38;5;129mgithub.com/khondoker\x1b[38;5;118mX\x1b[38;5;129mhasan')
		print()
		print()
